    ...
    <div class="map">
      ...
      <div class="location">
        <router-link to="/MountainChange">
          ...
          <div class="fish-man" @mouseenter="onFishMan" @mouseleave="offFishMan" v-if="show1"
               style="height: 8%;width: 17%;position: absolute;left: 19%;top: 14%" @click="getGreen1">
        ...
        <router-link to="/People">
          ...
          <div class="fish-man2" @mouseenter="onFishMan2" @mouseleave="offFishMan2" v-if="show2"
               style="height: 8%;width: 17%;position: absolute;left: 18%;top: 26%" @click="getGreen2">
        ...
        <router-link to="/History">
          ...
          <div class="fish-man3" @mouseenter="onFishMan3" @mouseleave="offFishMan3" v-if="show3"
               style="height: 8%;width: 17%;position: absolute;left: 14%;top: 55%" @click="getGreen3">
        ...
        <router-link to="/Visit">
          ...
          <div class="fish-man4" @mouseenter="onFishMan4" @mouseleave="offFishMan4" v-if="show4"
               style="height: 8%;width: 17%;position: absolute;left: 68%;top: 14%" @click="getGreen4">
        ...
        <div class="bp1" v-if="!green1"></div>
        <div class="bp2" v-if="!green2"></div>
        <div class="bp3" v-if="!green3"></div>
        <div class="bp4" v-if="!green4"></div>
        <div class="bp5" v-if="!green5"></div>
        <div class="bp1_1" v-if="green1"></div>
        <div class="bp2_2" v-if="green2"></div>
        <div class="bp3_3" v-if="green3"></div>
        <div class="bp4_4" v-if="green4"></div>
        <div class="bp5_5" v-if="green5"></div>
      ...
      top: -65%;left: 95%;z-index: 98" v-if="!showCloud">
        ...
        <div class="buttonStyle_2" v-if="!showCloud" @click="showCloud = !showCloud"></div>
      </div>
    </div>
...
<script>
  import {selectAccount,selectGrade,selectContent,green,selectGreen} from '../network/test.js'
  export default {
    data() {
      return {
        show: true,
        ...
        green1:false,green2:false,green3:false,green4:false,green5:false,
        wordContent : [
    ...
    methods: {
      ...
      _selectGreen(){
        selectGreen(1).then(res=>{
          if(res.data[0]){
            this.theGreen = res.data[0];
          }
          if(this.theGreen.shows === '1'){
            this.green1 = true;
          }
        });
        selectGreen(2).then(res=>{
          if(res.data[0]){
            this.theGreen = res.data[0];
          }
          if(this.theGreen.shows === '1'){
...
<style scoped>
  ...
  .bp1_1 {
    background: url("../assets/jpg/大绿点.png") no-repeat;
    width: 6%;
    height: 15%;
    position: absolute;
    background-size: 100% 100%;
