...
body {
  background: url("../assets/jpg/临安山核桃.jpg");
...
#page1 {
  background: url("../assets/jpg/原料.png");
  background-repeat: no-repeat;
  background-size: 100% 100%;
  width: 15%;
  height: 20%;
...
#page2 {
  background: url("../assets/jpg/锅炒.png");
  background-repeat: no-repeat;
  background-size: 100% 100%;
  width: 12%;
  height: 17%;
...
#page3 {
  background: url("../assets/jpg/盐速.png");
  background-repeat: no-repeat;
  background-size: 100% 100%;
  width: 10%;
  height: 15%;
...
#page4 {
  background: url("../assets/jpg/核桃.png");
  background-repeat: no-repeat;
  background-size: 100% 100%;
  width: 13%;
  height: 16%;
