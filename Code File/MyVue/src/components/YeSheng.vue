...
body {
  background: url("../assets/jpg/淡水鱼干.jpg");
...
#page1 {
  background: url("../assets/jpg/黑白鱼.png");
  background-repeat: no-repeat;
  background-size: 100% 100%;
  width: 15%;
  height: 20%;
...
#page2 {
  background: url("../assets/jpg/盐罐.png");
  background-repeat: no-repeat;
  background-size: 100% 100%;
  width: 12%;
  height: 17%;
...
#page3 {
  background: url("../assets/jpg/大红太阳.png");
  background-repeat: no-repeat;
  background-size: 100% 100%;
  width: 10%;
  height: 15%;
...
#page4 {
  background: url("../assets/jpg/三条鱼.png");
  background-repeat: no-repeat;
  background-size: 100% 100%;
  width: 13%;
  height: 16%;
