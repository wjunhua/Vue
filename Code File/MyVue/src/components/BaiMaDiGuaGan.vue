...
body {
  background: url("../assets/jpg/白马地瓜干.jpg");
...
#page1 {
  background: url("../assets/jpg/地瓜.png");
  background-repeat: no-repeat;
  background-size: 100% 100%;
  width: 15%;
  height: 20%;
...
#page2 {
  background: url("../assets/jpg/红薯.png");
  background-repeat: no-repeat;
  background-size: 100% 100%;
  width: 12%;
  height: 17%;
...
#page3 {
  background: url("../assets/jpg/红日.png");
  background-repeat: no-repeat;
  background-size: 100% 100%;
  width: 10%;
  height: 15%;
...
#page4 {
  background: url("../assets/jpg/地瓜干.png");
  background-repeat: no-repeat;
  background-size: 100% 100%;
  width: 13%;
  height: 16%;
