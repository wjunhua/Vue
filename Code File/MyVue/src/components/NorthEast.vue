...
.box1 {
  background: url("../assets/jpg/东北1.jpg") no-repeat;
  background-size: 100% 100%;
  width: 100%;
  height: 100%;
}
.box2 {
  background: url("../assets/jpg/东北2.jpg") no-repeat;
  background-size: 100% 100%;
  width: 100%;
  height: 100%;
}
.box3 {
  background: url("../assets/jpg/东北3.jpg") no-repeat;
  background-size: 100% 100%;
  width: 100%;
  height: 100%;
}
.box4 {
  background: url("../assets/jpg/东北4.jpg") no-repeat;
  background-size: 100% 100%;
  width: 100%;
  height: 100%;
}
