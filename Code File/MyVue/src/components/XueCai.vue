...
body {
  background: url("../assets/jpg/雪菜油饼.jpg");
...
#page1 {
  background: url("../assets/jpg/面粉.png");
  background-repeat: no-repeat;
  background-size: 100% 100%;
  width: 15%;
  height: 20%;
...
#page2 {
  background: url("../assets/jpg/肉馅.png");
  background-repeat: no-repeat;
  background-size: 100% 100%;
  width: 12%;
  height: 17%;
...
#page3 {
  background: url("../assets/jpg/全麦粉.png");
  background-repeat: no-repeat;
  background-size: 100% 100%;
  width: 10%;
  height: 15%;
...
#page4 {
  background: url("../assets/jpg/馅饼.png");
  background-repeat: no-repeat;
  background-size: 100% 100%;
  width: 13%;
  height: 16%;
